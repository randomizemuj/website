...
function Projects() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-[80%] lg:h-[80%] max-sm:h-auto bg-gray-600 flex sm:justify-center items-center max-sm:flex-col shadow-[0_15px_35px_rgba(0,0,0,0.5)] rounded-[40px] backdrop-blur-[10px] overflow-hidden max-sm:pt-1 max-sm:flex-wrap live-card">
      ...
      <div
        ...
        className=" max-md:h-[60vh] max-sm:h-auto max-sm:mb-40 max-lg:mb-[45%] h-screen w-screen px-6 lg:px-10 max-lg:h-[40vh] projects-container"
      >
        <div className="h-[80%] lg:h-[80%] max-sm:h-auto bg-gray-600 flex sm:justify-center items-center max-sm:flex-col shadow-[0_15px_35px_rgba(0,0,0,0.5)] rounded-[40px] backdrop-blur-[10px] overflow-hidden max-sm:pt-1 max-sm:flex-wrap passion-card">
          <div className="max-w-2xl w-[30%] max-sm:w-full text-center mb-6 max-sm:order-1 max-sm:mt-8 max-sm:mb-10 projectsHeading-container">
            <h2 className="text-3xl sm:text-5xl lg:text-7xl max-sm:text-4xl font-bold tracking-tight text-gray-800  max-sm:mt-6 hover:animate-pulse hover:cursor-default font-zain projectsHeading">
              Passion
              <br /> Projects
        ...
        <div className="h-[80%] lg:h-[80%] max-sm:h-auto bg-gray-600 flex sm:justify-center items-center max-sm:flex-col shadow-[0_15px_35px_rgba(0,0,0,0.5)] rounded-[40px] backdrop-blur-[10px] overflow-hidden max-sm:pt-1 max-sm:flex-wrap passion-card">
          ...
          <div className="mt-16 pr-6 pb-14 grid max-w-2xl auto-rows-fr grid-cols-[20vw,20vw,20vw] grid-rows-1 gap-10 max-sm:gap-5 max-sm:pl-6 lg:mx-0 lg:max-w-none px-2 max-sm:grid-cols-1 max-sm:grid-rows-[auto] max-sm:w-full max-sm:mt-0 max-sm:order-2 passionProjects-card">
            {PassionProjectsData.map((post) => (
              <article
                key={post.id}
                className="relative flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80 transition-transform duration-300 sm:hover:scale-125 hover:opacity-75 row-span-1 max-sm:w-full max-sm:h-[1%]"
              >
                <img
                  src={post.imageUrl}
                  alt=""
