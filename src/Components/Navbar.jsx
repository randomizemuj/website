        ...
        <nav className = {top ? nav : navactive}>
          ...
          <div className="flex items-center justify-between">
              ...
              <ul>
                <li>
                  <a href="/" className="flex items-center space-x-1">
                    <img className="h-10 mr-3" src='https://ucarecdn.com/20a00067-b313-4a73-b536-c7dedf5bc78c/-/preview/' alt="Randomize" />
                  </a>
                </li>
              </ul>
            </div>
            <div className="hidden md:block">
              ...
              <a href="/team" className="text-white hover:text-gray-300 px-3 py-2 rounded-md text-xl">
                Team
              </a>
