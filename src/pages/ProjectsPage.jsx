    ...
    <div className="min-h-screen w-screen text-white py-12 relative overflow-hidden flex flex-wrap justify-center projectsPage">
      ...
      <div className="container z-2  px-4 mt-10">
        <div className="centered pt-[] pb-[10%] ">
          <h1 className="text-8xl font-bold text-center mb-12 font-zain opacity-0 transition-opacity duration-[2000ms] projectsPageHeading" data-scroll>
            Projects
          </h1>
        ...
        <section className="mb-16 flex flex-wrap justify-center transform -translate-x-full transition-all duration-[3000ms] ease-in-out" data-scroll>
          <h2 className="text-3xl md:text-5xl font-semibold mb-8 w-full pl-[30%] lg:pl-[40%] mb-[10vh] ">Live Projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 w-[90vw] gap-8" >
            {LiveProjects.map((project) => (
              <Link to={project.href} key={project.id}>
                <div className="bg-gradient-to-br from-gray-900 to-gray-500 md:flex rounded-lg overflow-hidden shadow-lg transform transition duration-[3000ms] ease-in-out hover:scale-105" data-scroll>
                  <img
        ...
        <section className="mb-16 flex flex-wrap justify-center transform -translate-x-full transition-all duration-[3000ms] ease-in-out" data-scroll>
          <h2 className="text-3xl md:text-5xl font-semibold mb-8 w-full pl-[30%] lg:pl-[40%] mb-[10vh] ">Passion Projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 w-[90vw] gap-8" >
